        ...
        ZStack {
            ...
            VStack(alignment: .leading) {
                ...
                CrashChart(crashData: crashData)
                    .frame(maxHeight: 320)
                StatSection(statName: "Location", statVal: "(\(crashData.latitude),\(crashData.longitude))")
                    .frame(maxHeight: 80)
                StatSection(statName: "Total Time", statVal: String(format:"%i Seconds", Int(crashData.totalTime)))
                    .frame(maxHeight: 80)
